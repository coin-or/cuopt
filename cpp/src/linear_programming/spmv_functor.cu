...
#include "spmv_functor.cuh"
#include "spmv_functor_helpers.cuh"
...
spmv_functor_t<i_t, f_t>::spmv_functor_t(problem_t<i_t, f_t>& problem_,
...
template <typename i_t, typename f_t>
spmv_functor_t<i_t, f_t>::~spmv_functor_t()
{
...
template <typename i_t, typename f_t>
void spmv_functor_t<i_t, f_t>::setup_lb_problem(problem_t<i_t, f_t>& problem_, bool debug)
{
  pb            = &problem_;
  handle_ptr    = pb->handle_ptr;
  n_constraints = pb->n_constraints;
...
template <typename i_t, typename f_t>
void spmv_functor_t<i_t, f_t>::setup_lb_meta()
{
...
// template <typename i_t, typename f_t>
// void spmv_functor_t<i_t, f_t>::Ax(const raft::handle_t* h)
//{
...
//
// template <typename i_t, typename f_t>
// void spmv_functor_t<i_t, f_t>::ATy(const raft::handle_t* h,
...
template <typename i_t, typename f_t>
typename spmv_functor_t<i_t, f_t>::spmv_view_t spmv_functor_t<i_t, f_t>::get_A_view()
{
  spmv_functor_t::spmv_view_t v;
...
template <typename i_t, typename f_t>
typename spmv_functor_t<i_t, f_t>::spmv_view_t spmv_functor_t<i_t, f_t>::get_AT_view()
{
  spmv_functor_t::spmv_view_t v;
...
template class spmv_functor_t<int, float>;
#endif

#if MIP_INSTANTIATE_DOUBLE
template class spmv_functor_t<int, double>;
#endif
